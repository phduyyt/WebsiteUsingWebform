<%@ Page Title="" Language="C#" MasterPageFile="~/sub.Master" AutoEventWireup="true" CodeBehind="DonHangCuaToi.aspx.cs" Inherits="WebApplication1.DonHangCuaToi" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
        <Columns>
            ...
            <asp:TemplateField HeaderStyle-Width="150px" HeaderText="Xem chi tiết">
                <ItemTemplate>
                    <asp:Button Style="cursor: pointer; color:#54b8a6; font-weight:bold" runat="server" ID="xemDH" CommandName="xemDH" OnCommand="xemDH_Command" CommandArgument='<%# Bind("OrderId") %>'
                         Text="Xem" BackColor="#e5e5e5" BorderStyle="None" />
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderStyle-Width="100px" HeaderText="Hủy đơn">
                <ItemTemplate>
                    <asp:Button Style="cursor: pointer; color:#54b8a6; font-weight:bold" runat="server" ID="huyDH" CommandName="huyDH" OnCommand="huyDH_Command" CommandArgument='<%# Bind("OrderId") %>'
                         Text='<%# GetButtonText(Eval("State")) %>' BackColor="#e5e5e5" BorderStyle="None" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
