<%@ Page Title="" Language="C#" MasterPageFile="~/sub.Master" AutoEventWireup="true" CodeBehind="MyAccount.aspx.cs" Inherits="WebApplication1.MyAccount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h4>Sửa thông tin khách hàng</h4>
        ...
        <tr style="height: 100px; vertical-align: top">
            <td>Mật khẩu cũ:<br />
                 <asp:TextBox ID="txtRegisterPassword" runat="server" TextMode="Password" CssClass="form-control border-success"></asp:TextBox>
            ...
            <td>Mật khẩu mới:<br />
                 <asp:TextBox ID="txtNewPass" runat="server" TextMode="Password" CssClass="form-control border-success"></asp:TextBox>
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" Enabled="false" runat="server" ControlToValidate="txtNewPass" ErrorMessage="Vui lòng nhập mật khẩu." Display="Dynamic" CssClass="text-danger"></asp:RequiredFieldValidator>--%>
                        <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator1" Enabled="false" runat="server" ControlToValidate="txtNewPass" ValidationExpression="^\S{6,}$" ErrorMessage="Mật khẩu phải có ít nhất 6 ký tự và không chứa khoảng trắng." Display="Dynamic" CssClass="text-danger"></asp:RegularExpressionValidator>--%>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2" style="align-items: center; text-align: center">
                <asp:LinkButton Height="30px" Width="60" CssClass="bg-dark text-white" ID="suaKH" runat="server" CausesValidation="True" CommandName="suaKH" OnCommand="suaKH_Command" Text="Sửa"  />&nbsp;
                 <asp:LinkButton Height="30px" Width="60" CssClass="bg-dark text-white" ID="CancelButton" runat="server" CausesValidation="False" CommandName="Cancel" Text="Quay về" PostBackUrl="~/Home.aspx" />
            </td>
        </tr>
    </table>
